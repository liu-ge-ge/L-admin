	...
	<div class="setting">
		...
		<div class="right" v-if="props.isShowTools">
			...
			<a-tooltip placement="topLeft">
				...
				<fullscreen-outlined
					style="color: var(--ant-primary-color); margin-right: 20px"
			...
			<a-dropdown>
				...
				<template #overlay>
					<a-menu>
						<a-menu-item>
							<a href="javascript:;" @click="() => (tableSize = 'default')"
								>默认</a
							>
						</a-menu-item>
						<a-menu-item>
							<a href="javascript:;" @click="() => (tableSize = 'middle')"
								>中等</a
							>
						</a-menu-item>
						<a-menu-item>
							<a href="javascript:;" @click="() => (tableSize = 'small')"
								>紧凑</a
							>
						</a-menu-item>
					</a-menu>
