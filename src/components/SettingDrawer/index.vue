<template>
  <more-outlined @click="showDrawer" style="margin-left: 20px; font-size: 20px" />
  <a-drawer
    :closable="false"
  ...
  >
    ...
    <div class="item" style="margin-top: 20px">
      ...
      <div class="colorList">
        <div class="block" :style="{ backgroundColor: item }" v-for="item in predefineColors" :key="item"></div>
