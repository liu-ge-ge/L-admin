<template>
  <a-dropdown class="drop">
    ...
    <template #overlay>
      <div class="antd-tabs">
        <a-tabs v-model:activeKey="activeKey" style="width: 80%" :centered="true">
          <a-tab-pane key="1" tab="通知" style="justify-content: center">
            <a-list item-layout="horizontal" :data-source="notice" style="max-height: 400px; overflow-y: auto">
