<template>
  <a-card class="l-card">
    <table-plus :data-source="data" :columns="columns" :isShowTools="true">
      <!-- <template #plusTitle>
    ...
    <role-auth @cancel="roleCancel" :visible="authVisible"></role-auth>
    <role-edit @cancel="editCancel" :visible="editVisible"></role-edit>
  </a-card>
</template>
