<template>
  <a-card>
    <table-plus :data-source="data" :columns="columns" :pagination="{ showSizeChanger: true }">
      <template #plusTitle>
        <a-button @click="exportExcelFormServe(['name', 'chinese'])" type="primary">
          <download-outlined />
          导出
        </a-button>
      </template>
    ...
    <a-spin tip="Loading...">
      <a-alert message="Alert message title" description="Further details about the context of this alert."></a-alert>
    </a-spin>
  </a-card>
</template>
