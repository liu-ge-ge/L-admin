...
export declare function toggleFullscreen(el?: HTMLElement, fullscreen?: boolean): boolean
...
export declare function divTOimage(el: stringl, callback: (a: HTMLElement) => void): void
